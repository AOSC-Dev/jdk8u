...
ifneq ($(OSNAME),windows)
  ...
  SRCARCH    ?= $(ARCH/$(filter sparc sparc64 ia64 amd64 x86_64 ppc ppc64 ppc64le mips64 zero aarch64,$(ARCH)))
  ARCH/       = x86
  ARCH/sparc  = sparc
  ARCH/sparc64= sparc
  ARCH/ia64   = ia64
...
#      endif
  ...
  LP64_ARCH += sparcv9 amd64 ia64 ppc64 mips64 mips64el aarch64 zero
  ifeq ($(LIBARCH), mips64)
    ifeq ($(OPENJDK_TARGET_CPU_ENDIAN), little)
      LIBARCH  = mips64el
    else
